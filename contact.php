...
<body>
    ...
    <div class="contact">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h3 class="pb-4 text text--black text--big30 mb-4">
                        Contact us
                    </h3>
                </div>
                <div class="offset-md-1 col-md-10">
                    <div class="row">
                        <div class="col-lg-3 col-md-4">
                            <p class="text text--bold text--regular20 pb-3">
                                Address
                            </p>
                            ...
                            <p class="pb-5 text text--small15">
                                <a href="tel:+56988914740">+569 8891 4740</a>
                            </p>
                            <div class="pb-5">
                                <div class="mb-3">
                                    <a href="" target="_blank" class="button button--full u-upper">
                                        INSTAGRAM
                                    </a>
                                </div>
                                <div class="mb-3">
                        ...
                        <div class="offset-lg-1 col-lg-7 col-md-8 pb-5">
                            <h3 class="pb-4 text text--black text--big30 u-center">
                                Contact form
                            </h3>
                            <div class="form pb-5">
                                <form action="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 u-center mb-5">
                                            <a href="" class="button button--p60">Submit</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                            <h3 class="pb-2 text text--black text--big30 u-center">
                                Subscribe to our newsletter
                            </h3>
                            <p class="pb-3 u-center">
                                Stay up-to-date with new releases and special sales.
                            </p>
                            <div class="form mb-5">
                                <form action="">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 u-center mb-5">
                                            <a href="" class="button button--p60">Subscribe</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
