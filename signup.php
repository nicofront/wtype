...
<head>
    ...
    ********************************************************************
    ...
    <title>Sign Up | FoundryCore | A web solution for independent font foundries</title>
                    ...
                    <div class="fc-formWrapper">
                        <form method="POST">
                            ...
                            <div class="form-group submit">
                                <button class="btn btn-primary" type="submit" name="registration"
                                    value="registration">Create Account</button>
                                <span class="btn">Already have an account? <a class="link" href="login.php">Sign
                                        in</a></span>
                            </div>
