...
<body>
        ...
        <div class="row">
            ...
            <div class="col-md-7 mb-4">
                ...
                <div class="categories">
                    <ul>
                        <li>
                            <a href="" class="transition u-upper button">
                                New fonts
                            </a>
                        </li>
                        <li>
    ...
    <div class="container-xl mb-5">
        <div class="row">
            <div class="col-md-12">
                <div class="text text--big30 mb-5">
