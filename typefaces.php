...
<body>
    ...
    <div class="container mb-5">
        <div class="row">
            <div class="col-md-12">
                <h3 class="pb-4 text text--big30 text--black mb-2">
                    Typefaces
                </h3>
            </div>
    ...
    <div class="container mb-5 mb-5">
        <div class="row">
            <div class="typos col-md-10 offset-md-1">
                <div class="typoitem mb-4">
                    <div class="row">
                        <div class="typoitem__info col-lg-3 mb-3">
                            <h3 class="text text--regular20 text--bold">
                                Adorno Noveau
                            </h3>
                            <p class="pb-0 text text--regular17">
                                2 styles
                            </p>
                        </div>
                        <div class="col-lg-6 col-sm-8 col-12 mb-1 u-center typoitem__name">
                            <h4 class="text text--big100 text--black">Barroco</h4>
                        </div>
                        <div class="typoitem__info col-lg-3 col-sm-4 col-12">
                            <div class="u-right">
                ...
                <div class="typoitem mb-4">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-sm-8 col-12 mb-1 u-center typoitem__name typoitem__name--new">
                            <h4 class="text text--big100 text--black">Barroco</h4>
                        </div>
                        <div class="typoitem__info col-lg-3 col-sm-4 col-12">
                            <div class="u-right">
                ...
                <div class="typoitem mb-4">
                    <div class="row">
                        <div class="typoitem__info col-lg-3 mb-3">
                            ...
                            <p class="pb-4 text text--regular17">
                                2 styles
                            </p>
                        </div>
                        <div class="col-lg-6 col-sm-8 col-12 mb-1 u-center typoitem__name typoitem__name--new">
