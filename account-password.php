                ...
                <div class="fc-section__content">
                    ...
                    <div class="fc-alertWrapper">
						<div class="alert alert-danger">
							Please note, passwords must be identical!
                        </div>
                    </div>
                    ...
                    <div class="fc-formWrapper">
                        <form method="POST">
                            ...
                            <div class="submit form-group">
                                <button class="btn btn-primary" type="submit" name="update" value="update">Change
                                    password</button>
                                <span class="btn"><a href="http://foundrycore-vat.test/account">Back to
                                        account</a></span>
                            </div>
                        </form>
                    </div>
