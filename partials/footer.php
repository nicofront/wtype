	...
	<div class="container-xl">
		<div class="row">
			<div class="col-md-12 footer__top">
				...
				<a href="" class="footer__back u-upper">
					Back to top
				</a>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-lg-6 col-md-4 footer__list">
				...
				<ul>
					<li>
						<a href="" target="_blank">My Fonts</a>
					</li>
					<li>
						<a href="" target="_blank">Type Department</a>
					</li>
					<li>
						<a href="" target="_blank">Type 01</a>
					</li>
					<li>
						<a href="" target="_blank">Design Cuts</a>
					</li>
					<li>
						<a href="" target="_blank">Creative Markets </a>
					</li>
				</ul>
			</div>
			<div class="col-md-12">
