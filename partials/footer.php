	...
	<div class="container-xl">
		<div class="row">
			<div class="col-md-12 footer__top">
				...
				<a href="" class="footer__back u-upper text text--big30 text--extrabold u-transition" id="toTop">
					Back to top
				</a>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-1 col-md-4 footer__list">
				<h6 class="text text--small13 text--bold pb-2">
					Menu
				</h6>
				<ul>
					<li>
						<a class="text text--small13" href="">Typefaces</a>
					</li>
					<li>
						<a class="text text--small13" href="">About</a>
					</li>
					<li>
						<a class="text text--small13" href="">Blog</a>
					</li>
					<li>
						<a class="text text--small13" href="">Licences</a>
					</li>
				</ul>
			</div>
			<div class="col-lg-1 col-md-4 footer__list">
				...
				<ul>
					<li>
						<a class="text text--small13" href="" target="_blank">Email</a>
					</li>
					<li>
						<a class="text text--small13" href="" target="_blank">Instagram</a>
					</li>
					<li>
						<a class="text text--small13" href="" target="_blank">Twitter</a>
					</li>
					<li>
						<a class="text text--small13" href="" target="_blank">Behance</a>
					</li>
				</ul>
			</div>
			<div class="col-lg-6 col-md-4 footer__list">
				<h6 class="text text--small13 text--bold pb-2">
					Distribuidoras autorizadas
				</h6>
				<ul>
					<li>
						<a class="text text--small13" href="" target="_blank">My Fonts</a>
					</li>
					<li>
						<a class="text text--small13" href="" target="_blank">Type Department</a>
					</li>
					<li>
						<a class="text text--small13" href="" target="_blank">Type 01</a>
					</li>
					<li>
						<a class="text text--small13" href="" target="_blank">Design Cuts</a>
					</li>
					<li>
						<a class="text text--small13" href="" target="_blank">Creative Markets </a>
					</li>
				</ul>
			</div>
			<div class="col-md-12">
				<div class="footer__copyright">
					<h5 class="text text--small13">
						© W Type Foundry 2021
					</h5>
				</div>
			</div>
